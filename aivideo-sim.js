/* ============================================================
   Oson Studio — "AI bilan video yaratish" kursi: interaktiv simulyator (VidSim)
   window.VidSim.mount(host, cfg)
   ...
   • "build" — video prompt quruvchi: har bo'lim uchun eng kuchli variantni tanlash
   ...
   Hech narsa baholanmaydi — mustaqil mashq. CSS: .asim-* + .bsim-* + .csim-* (aivideo-kurs.html'da).
   ============================================================ */
(function () {
  "use strict";
  ...
  function mountBuild(host, cfg) {
    ...
    bChk.addEventListener("click", function () {
      ...
      if (ok === slots.length) feedback(fb, true, "Zo'r! Kuchli, aniq video prompt yig'ildi (" + ok + "/" + slots.length + ").");
